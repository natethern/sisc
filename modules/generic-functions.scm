...
(define (add-generic-function f name)
  (monitor/synchronize-unsafe *FUNCTIONS-LOCK*
...
(define (get-methods name)
  (monitor/synchronize-unsafe *METHODS-LOCK*
                              (lambda ()
                                (let ([m (*METHODS* name)])
...
(define (get-constructors class)
  (monitor/synchronize-unsafe  *CONSTRUCTORS-LOCK*
                               (lambda ()
...
(define (add-method-helper m methods)
  (monitor/synchronize-unsafe (car methods)
