...
(define char-set:upper-case	(void))
(define char-set:title-case	(void))
(define char-set:letter		(void))
(define char-set:digit		(void))
(define char-set:hex-digit	(void))
(define char-set:letter+digit	(void))
(define char-set:punctuation	(void))
(define char-set:symbol		(void))
(define char-set:graphic	(void))
(define char-set:whitespace	(void))
(define char-set:printing	(void))
...
(set! char-set:title-case char-set:empty)
...
(set! char-set:digit     (string->char-set "0123456789"))
(set! char-set:hex-digit (string->char-set "0123456789abcdefABCDEF"))

(set! char-set:letter+digit
  (char-set-union char-set:letter char-set:digit))

(set! char-set:punctuation
...
(set! char-set:printing (char-set-union char-set:whitespace char-set:graphic)) ; NO-BREAK SPACE
...
(set! char-set:ascii (ucs-range->char-set 0 128))
