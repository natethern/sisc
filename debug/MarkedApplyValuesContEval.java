...
public class MarkedApplyValuesContEval extends ApplyValuesContEval {
    public int lineNo, colNo;
    public String filename;

    public MarkedApplyValuesContEval(Procedure c, int lineNo, int colNo, String filename) {
	super(c);
	this.lineNo=lineNo;
	this.colNo=colNo;
    ...
    public MarkedApplyValuesContEval() {}
