...
public class Library {
    ...
    public static Library load(SeekableDataInput di) throws IOException, ClassNotFoundException {
        ...
        return new Library(new BinaryDeserializer(di, classes, sharedObjectOffsets), names);
    }
        
        /* All this and more at your */ 
    public Library(BinaryDeserializer lib, Map names) {
        this.lib=lib;
        this.names=names;
        lib.baseLib=this;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Expression e=l.getExpression(Integer.parseInt(args[1]));
