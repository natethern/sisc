    ...
    (letrec ((%_2770
               (lambda (%_2788 %_2789)
                 (letrec ((%_2790
                            (lambda (%_2799 %_2800)
                              ((lambda (%_2801)
                                 (if %_2801
                                   (%_2770 (%_2769 %_2799) (%_2769 %_2801))
                                   '#f))
                               (%_2769 %_2800)))))
                   (if %_2789
                     (if (not (eq? (car %_2789) (car %_2788)))
                       (%_2790 %_2788 %_2789)
                       ((letrec ((%_2791
                                   (lambda (%_2792 %_2793)
                                     ((lambda (%_2794)
             ...
             (%_2769
               (lambda (%_2778)
                 ((lambda (%_2779)
                    ((letrec ((%_2780
                                (lambda (%_2781 %_2782 %_2783)
                                  (if (>= %_2782 '0)
                                    ((lambda (%_2787)
                                       (if (%_2766 %_2787)
                                         (cons %_2787 (cons %_2782 %_2783))
                                         (%_2780 %_2781 (- %_2782 '1) %_2783)))
                                     (%_2768 %_2781 %_2782))
                                    ((lambda (%_2784)
                                       (if (pair? %_2784)
                                         ((lambda (%_2786 %_2785)
             ...
             (%_2768
               (lambda (%_2776 %_2777)
                 (if (vector? %_2776)
                   (vector-ref %_2776 %_2777)
                   (if (box? %_2776)
                     (unbox %_2776)
                     ((if (zero? %_2777) car cdr) %_2776)))))
             (%_2767
               (lambda (%_2775)
                 (if (pair? %_2775)
                   '2
                   (if (box? %_2775) '1 (vector-length %_2775)))))
             (%_2766
               (lambda (%_2772)
                 ((lambda (%_2773)
                    (if %_2773
                      ...
                      ((lambda (%_2774)
                         (if %_2774
                           %_2774
                           (if (vector? %_2772)
                             (not (zero? (vector-length %_2772)))
                             '#f)))
                       (box? %_2772))))
                  (pair? %_2772)))))
      (if (%_2766 %_2765)
        ((lambda (%_2771) (%_2770 %_2771 (%_2769 %_2771)))
         (list %_2765))
        '#f))))
                           ...
                           ((lambda (%_2967)
                              (if (memv %_2967 '(#\a))
                                (if (null? %_2966)
                                  ...
                                  (begin
                                    (display (car %_2966) %_2963)
                                    (%_2964 (cddr %_2965) (cdr %_2966))))
                                (if (memv %_2967 '(#\s))
                                  (if (null? %_2966)
                                    (error 'format
                                           '"No value for escape sequence")
                                    (begin
                                      (write (car %_2966) %_2963)
                                      (%_2964 (cddr %_2965) (cdr %_2966))))
                                  (if (memv %_2967 '(#\%))
                                    (begin
                                      (display '#\newline %_2963)
                                      (%_2964 (cddr %_2965) %_2966))
                                    (if (memv %_2967 '(#\~))
                                      (begin
                                        (display '#\~ %_2963)
                                        (%_2964 (cddr %_2965) %_2966))
                            ...
                            (cadr %_2965)))
                         (begin
                           (display (car %_2965) %_2963)
                           (%_2964 (cdr %_2965) %_2966)))))))
          %_2964)
        (string->list %_2962)
        %_2961))
     (open-output-string))))
